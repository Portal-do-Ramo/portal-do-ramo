...
Aproveitamos para lembrar que se não for solicitada audiência em até uma semana neste strike, o somatório de strike do membro {{ $strike->membroRecebeu->nome_completo }} alcançará o valor de: {{ $strike->membroRecebeu->strikesRecebeuAprovados()->count() }}.
