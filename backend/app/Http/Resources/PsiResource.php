...
class PsiResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'aberto' => $this->aberto,
            'membro_criou' => $this->membroCriou()->select('matricula', 'nome_completo', 'foto_url')->join('hierarquias', 'usuarios.hierarquia_id', '=', 'hierarquias.id')->addSelect('hierarquias.nome as hierarquia')->first(),
