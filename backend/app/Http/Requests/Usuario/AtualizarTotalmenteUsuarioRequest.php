...
class AtualizarTotalmenteUsuarioRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'numero_ieee' => 'present|nullable|required_if:pagante,true',
            'data_fim_membresia' => 'present|nullable|required_if:pagante,true',
            'cadastro_robocore' => ['present','nullable', new CadastroRobocore($this->input('email_usuario'))],
            'tipo_sanguineo' => 'required',
            'medicamentos_utiliza' => 'required',
            'medicamentos_alergico' => 'required',
            'condicao_especial' => 'required',
            'alimentos_alergico' => 'required',
