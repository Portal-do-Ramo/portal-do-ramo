...
export default function ShutdownRequest() {
  ...
  function sendShutdown(e){
    ...
    api.post('/api/pedidos/pedido-de-desligamento', {
  ...
  return (
    <Screen>
      ...
      <div className="container">
        <Header />
        <Title title="Pedido de Desligamento" />

        <Content>
          <h1>Olá {username}!</h1>
          <h2>Informe-nos abaixo a justificativa do seu desligamento.</h2>
          <div id="alert" />
